...
var LIGHT_X = 0, LIGHT_Y = 9, LIGHT_Z = 3; // Position of the light source
...
function initVertexBuffersForPlane(gl) {
  ...
  var vertices = new Float32Array([
    3.0, -1.7, 2.5,   -5.0, -1.7, 2.5,   -5.0, -1.7, -2.5,   3.0, -1.7, -2.5,    // v0-v1-v2-v3
    -5.0, 2.7, -2.5,    3.0, 2.7, -2.5
  ]);
  ...
  var indices = new Uint8Array([0, 1, 2,   0, 2, 3,  2, 3, 4,  3, 4, 5]);
